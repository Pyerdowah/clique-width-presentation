...
\begin{frame}
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}[scale=0.5, every node/.style={draw, circle, inner sep=1pt, minimum size=6pt}]
            ...
            \draw[red, bend left] (n2) to (v1);
            \draw[red, bend left] (n2) to (v3);
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}[scale=0.5, every node/.style={draw, circle, inner sep=1pt, minimum size=6pt}]
            ...
            % First neighborhood
            \node (n1) [fill=blue, ellipse, draw=blue, minimum size=10pt, text=white] at ($(v1) + (4, 1)$) {$V_{1,3,4}$};
            \node (n2) [fill=blue, ellipse, draw=blue, minimum size=10pt, text=white] at ($(v1) + (2, 1)$) {$V_{1,3}$};
            \node (n3) [fill=blue, ellipse, draw=blue, minimum size=10pt, text=white] at ($(v1) + (-2, 1)$) {$V_{1,2,5}$};
            \node (n4) [fill=blue, ellipse, draw=blue, minimum size=10pt, text=white] at ($(v1) + (-4, 1)$) {$V_{1,4}$};
            
            % Edges from first neighborhood to initial cycle
            \draw[blue, bend left] (n1) to (v1);
            \draw[blue, bend left] (n1) to (v3);
...
\begin{frame}
    ...
    \begin{figure}[h]
        ...
        \begin{tikzpicture}[scale=0.5, every node/.style={draw, circle, inner sep=1pt, minimum size=6pt}]
            ...
            \draw[red, bend right] (n2) to (v1);
            \draw[red, bend right] (n2) to (v3);
